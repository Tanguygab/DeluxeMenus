...
public class RegistrableMenuCommand extends Command {
    ...
    public void unregister() {
        ...
        final Map<String, Command> knownCommandsMap = Bukkit.getServer().getCommandMap().getKnownCommands();
        ...
        boolean unregistered = this.unregister(Bukkit.getServer().getCommandMap());
